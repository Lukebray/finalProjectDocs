...
\subsubsection{PiBB - SR001}
\begin{center}
  \framebox{\textit{The system will be able to output a live HD video feed of the inside of the dark nest box. This allows a user to see if anything is living inside of the nest box.}}\par
\end{center}
